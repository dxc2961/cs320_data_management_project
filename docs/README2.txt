...
you will be prompted to enter your user email, and then your password.
    ...
    Shipping Employee: This interface is for shipping employees to view and edit certain information regarding
        ...
        for a package using an order id provides the employee with package information for each of the packages in the
        order.

    Database Administrator: This interface is for the handlers of the database. The administrator can
        either craft their own SQL scripts or they can launch a new application instance of one of the other interfaces.
